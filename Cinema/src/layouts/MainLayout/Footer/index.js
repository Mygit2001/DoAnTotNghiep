      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          ...
          <div className={`col-12 col-md-9 p-1 text-center text-lg-left`}>
            <span>TIX - SẢN PHẨM CỦA CÔNG TY CỔ PHẦN ABC</span>
            <span>Địa chỉ: Bắc Từ Liêm, Hà Nội, Việt Nam.</span>
            <span>Giấy chứng nhận đăng ký kinh doanh số: 0101659783,</span>
            <span>đăng ký thay đổi lần thứ 30, ngày 22 tháng 01 năm 2020 do Sở kế hoạch và đầu tư Thành phố Hà Nội cấp.</span>
